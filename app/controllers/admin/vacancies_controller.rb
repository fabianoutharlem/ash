module Admin
  class VacanciesController < AdminBaseController
    ...
    def create
      ...
      respond_to do |format|
        if @vacancy.save
          format.html { redirect_to admin_vacancies_path, notice: 'Vacature is aangemaakt.' }
    ...
    def destroy
      @vacancy.destroy
      respond_to do |format|
        format.html { redirect_to admin_vacancies_path, notice: 'Vacature is verwijderd.' }
    ...
    def vacancy_params
      params.require(:vacancy).permit(:title, :sub_title, :description)
    end
  end
end